...
import com.gsk.sup.gskmt.autoupdate.AutoupdateActivity;
...
/**
 * Created by jeevanp on 12-05-2017.
 */
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login_version = (TextView) findViewById(R.id.tv_version_code);
        mUsername = (AutoCompleteTextView) findViewById(R.id.userid);
        mPassword = (EditText) findViewById(R.id.password);
        mLogin = (Button) findViewById(R.id.user_login_button);
       /* mUsername.setText("testsup1");
        ...
        try {
            ...
            login_version.setText("Version " + app_ver);
            ...
            try {
                ...
                if (result.toString().equalsIgnoreCase(CommonString.KEY_FAILURE)) {
                    ...
                    if (failureGetterSetter.getStatus().equalsIgnoreCase(CommonString.KEY_FAILURE)) {
                        ...
                        editor.putString(CommonString.KEY_RIGHT_NAME, lgs.getRIGHT_NAME());
                        editor.commit();
